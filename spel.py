...
mixer.music.load("Radiohead_everything_in_its_right_place.mp3")
...
city_2 = pygame.image.load(os.path.join('.','backest_ground_city_4.png')).convert_alpha()
...
van_gogh_uitleg = pygame.image.load(os.path.join('.','van_gogh_uitleg.png')).convert_alpha()
aap_beeld_uitleg = pygame.image.load(os.path.join('.','aap_beeld_uitleg.png')).convert_alpha()
jan_de_man_uitleg = pygame.image.load(os.path.join('.','jan_de_man_uitleg.png')).convert_alpha()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load(os.path.join('.','civ_car.png')).convert_alpha()
        #self.surf.fill((0, 0, 0))
        self.surf.set_colorkey((255, 255, 255), pygame.RLEACCEL)
        self.rect = self.surf.get_rect()
            ...
            if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_1:
                        try:
                            ...
                            pass
                        mixer.music.load("black_midi_sugar_tzu.mp3")
                        mixer.music.set_volume(0.2)
                        mixer.music.play()
            if event.type == pygame.KEYDOWN:
            ...
            if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_3:
                        try:
                            ...
                            pass
                        mixer.music.load("Aphex_twin_xtal.mp3")
                        mixer.music.set_volume(0.2)
                        mixer.music.play() 
            if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_4:
                        try:
                            ...
                            pass
                        mixer.music.load("death_grips_hacker.mp3")
                        mixer.music.set_volume(0.2)
                        mixer.music.play()
            if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_5:
                        try:
                            ...
                            pass
                        mixer.music.load("aint_it_funny_danny_brown.mp3")
                        mixer.music.set_volume(0.2)
                        mixer.music.play()  
        if event_status == 1:
            street_x = street_x - speed
            street_x_2 = street_x_2 - speed
            city_x = city_x - speed / 8
            city_x_2 = city_x_2 - speed / 8
            window.blit(city, (city_x, 0))
            window.blit(city_2, (city_x_2, 0))
            ...
            if city_x_2 <= -8000:
                city_x_2 = city_x + 8000
                webbrowser.open_new('https://www.youtube.com/watch?v=51o5J0XVGoc')
            enemies.update()
        elif event_status == 0:
            if aap_beeld_x > -800:
            ...
            if jan_de_man_x > -800:
                ...
                window.blit(jan_de_man_uitleg, (jan_de_man_x + 300, 100))
                jan_de_man_x = jan_de_man_x - 5
                print(jan_de_man_x)
            if jan_de_man_x <= -800 and sterrennacht_x > -800:
                if not sterrennacht_grabbed:
                    window.blit(sterrennacht, (sterrennacht_x, 100))
                window.blit(van_gogh_uitleg, (sterrennacht_x + 300, 100))
                sterrennacht_x = sterrennacht_x - 5
                print(sterrennacht_x)
            if sterrennacht_x <= -800 and aap_beeld_x > -800:
                if not aap_beeld_grabbed:
                    window.blit(beeld_van_apa, (aap_beeld_x, 100))
                window.blit(aap_beeld_uitleg, (aap_beeld_x + 300, 100))
                aap_beeld_x = aap_beeld_x - 5
                print(aap_beeld_x)
            if aap_beeld_x <= -800 and car_museum_x <= 1000:
